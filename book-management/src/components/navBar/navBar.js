    ...
    return (
      <>
        ...
        <div className="sticky -top-1 bg-gray-900 text-white bg-opacity-90 flex justify-center items-center pt-4 pb-3 z-40">
            ...
            <div className="w-2/5 font-semibold hidden lg:block xl:block 2xl:block">
                <ul className="flex justify-between ">
                    <li className="cursor-pointer hover:text-blue-400 border-b border-transparent hover:border-white transition duration-500 ease-in-out"><Link to="/">Home</Link></li>
                    ...
                    <li className="cursor-pointer hover:text-blue-400 border-b border-transparent hover:border-white transition duration-500 ease-in-out"><Link to={{pathname: '/sign-up', state: {from: 'signOut'}}}>Sign out</Link></li>
                </ul>
            </div>
            : 
            role === "buyer" ? 
        ...
        <ul>
               ...
               <li className="cursor-pointer hover:text-blue-400 mt-3 transition duration-500 ease-in-out"><Link to={{pathname: '/sign-up', state: {from: 'signOut'}}}>Sign out</Link></li>
           </ul>
           </div>
          </div>
       </div>
        ...
        <div className="pt-6">
          ...
          <div className="w-full flex justify-center pt-4">
            <ul>
               <li className="cursor-pointer hover:text-blue-400 transition duration-500 ease-in-out"><Link to="/sign-up">SignUp</Link></li>
               <li className="cursor-pointer hover:text-blue-400 mt-3 transition duration-500 ease-in-out "><Link to="/sign-in">SignIn</Link></li>
           </ul>
           </div>
          </div>
       </div>
